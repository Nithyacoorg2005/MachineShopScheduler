...
def main():
    ...
    print("Running structural and realism validations...")
    try:
    ...
    # Save the final validated output
    output_path = "data/generated/baseline.json"
    with open(output_path, "w") as f:
        json.dump(validated_dataset, f, indent=2)
        
    print(f"Validated baseline dataset successfully saved to {output_path}")
